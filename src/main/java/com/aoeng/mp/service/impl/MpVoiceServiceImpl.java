...
public class MpVoiceServiceImpl extends MpServiceImpl implements MpService {
	...
	public void resp(MpInputMsg inputMsg, HttpServletResponse resp) {
		...
		String content = String.format("save Voice ok mediaId : %s thumbMediaId %s ", mediaId, thumbMediaId);
